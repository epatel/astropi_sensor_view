...
- **Sensor readouts** -- temperature, humidity, pressure, barometric altitude, accelerometer, gyroscope, magnetometer with sparkline history
...
- **Presets** -- rainbow, heatmap, snake, sparkle, compass, flame, level animations
